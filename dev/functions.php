...
/**
 * Optional: Add theme support for slick slider.
 */
require get_template_directory() . '/pluggable/slick/slick.php';

/**
 * Optional: Add theme support for swiper slider.
 */
require get_template_directory() . '/pluggable/swiper/swiper.php';
